...
@section('content')
  <div class="auth-wrapper auth-v2">
    <div class="auth-inner row m-0">
      <!-- Brand logo-->
      <a class="brand-logo" href="javascript:void(0);" style="margin-top: -15px;">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="150px" height="50px" viewBox="0 0 1771 408" enable-background="new 0 0 1771 408" xml:space="preserve">  <image id="image0" width="1771" height="408" x="0" y="0"
...
{{--        <h2 class="brand-text text-primary ml-1">Financely</h2>--}}
      </a>
      <!-- /Brand logo-->
      <!-- Left Text-->
      ...
      <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
          <h2 class="card-title font-weight-bold mb-1">Welcome to Financely! &#x1F44B;</h2>
          <p class="card-text mb-2">Please Sign-in to your account and begin your journey to wealth</p>
